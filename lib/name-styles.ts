...
export const NAME_STYLES: Record<string, NameStyleDef> = {
  ...
  warm_white:  { key:"warm_white",  label:"Warmes Weiß",   description:"Warmes, cremiges Weiß.",                  rarity:"normal",   category:"solid",    color1:"#fef3c7",                                       animation_type:"none",       animation_speed:1,   glow_color:undefined,  glow_radius:0,  prefix_icon:undefined, suffix_icon:undefined, unlock_price_cr:50000,   can_win_from_case:true,  is_special:false },
  ...
  void:        { key:"void",        label:"Void",          description:"Purpur-Schwarz — das Nichts selbst.",    rarity:"ultra",    category:"glow",     color1:"#9333ea", color2:"#4c1d95",                     animation_type:"pulse",      animation_speed:1.8, glow_color:"#7c3aed",  glow_radius:20, prefix_icon:undefined, suffix_icon:undefined, unlock_price_cr:12000000, can_win_from_case:true,  is_special:false },
