    ...
    >
      ...
      {isAvailable && (
        <motion.button
          whileTap={{ scale: 0.9 }}
          disabled={claiming}
          className="mt-1 w-full rounded-lg py-1.5 text-[11px] font-black text-white transition-all disabled:opacity-50"
          style={{
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-4 py-10 text-center">
          ...
          {pass.description && (
            <motion.p
              ...
              className="mx-auto mt-4 max-w-xl text-base text-white/60 leading-relaxed"
            >
              {pass.description}
            </motion.p>
          )}
      ...
      <AnimatePresence>
        {toast && (
          <motion.div
            ...
            className={`fixed bottom-6 left-1/2 -translate-x-1/2 z-50 rounded-2xl border px-6 py-3 text-sm font-bold shadow-2xl backdrop-blur-xl ${
              toast.ok
