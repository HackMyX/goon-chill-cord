...
const SEARCH_INDEX: { label: string; tab: Tab; keywords: string[]; description: string; anchor?: string }[] = [
  ...
  { label: "Belohnungs-Feedback", tab: "feedback", keywords: ["feedback", "belohnung", "celebration", "popup", "toast", "xp", "level up", "levelup", "meilenstein", "quest", "abgeschlossen", "battle pass", "battlepass", "konfetti", "confetti", "animation", "farbe", "sound", "feier", "intensität", "intensity", "partikel", "feuerwerk", "fireworks", "sterne", "luftschlangen", "screen-blitz", "screen flash", "shockwave", "episch", "vollbild", "vollbild-feier", "fullscreen", "level-up-feeling", "quest-feier", "stil", "benachrichtigungs-toast", "notification toast", "live-toast", "trade", "shop-toast"], description: "XP/Level/Quest/Battle-Pass-Feedback: Stil (Toast/Popup/Vollbild-Feier), Farbe, Animation, Intensität, Partikel (Konfetti/Feuerwerk/Sterne), Screen-Blitz, Sound pro Event + Benachrichtigungs-Toasts" },
