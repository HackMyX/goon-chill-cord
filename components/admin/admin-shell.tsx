...
const SEARCH_INDEX: { label: string; tab: Tab; keywords: string[]; description: string; anchor?: string }[] = [
  ...
  { label: "Belohnungs-Feedback", tab: "feedback", keywords: ["feedback", "belohnung", "celebration", "popup", "toast", "xp", "level up", "levelup", "meilenstein", "quest", "abgeschlossen", "battle pass", "battlepass", "konfetti", "confetti", "animation", "farbe", "sound", "feier", "intensität", "intensity", "partikel", "feuerwerk", "fireworks", "sterne", "luftschlangen", "screen-blitz", "screen flash", "shockwave", "episch", "vollbild", "vollbild-feier", "fullscreen", "level-up-feeling", "quest-feier", "stil", "benachrichtigungs-toast", "notification toast", "live-toast", "trade", "shop-toast", "aufschieben", "während spiel", "nach der runde", "stören", "snake tod", "spiel unterbrechen", "defer"], description: "XP/Level/Quest/Battle-Pass-Feedback: Stil (Toast/Popup/Vollbild-Feier), Farbe, Animation, Intensität, Partikel, Screen-Blitz, Sound pro Event + Benachrichtigungs-Toasts + große Feiern erst nach der Runde" },
  ...
  { label: "Chat-Einstellungen", tab: "chat", keywords: ["chat", "nachrichten", "filter", "rate", "limit", "global", "stumm", "stummschalten", "mute", "sperre", "moderation", "broadcast", "broadcasten", "gewinn", "ankündigung", "gezogen", "seltenheit", "banner"], description: "Chat-Konfiguration, Moderation, Stummschaltung & Gewinn-Broadcasts" },
  ...
  { label: "Shop-Automatik & Kategorien", tab: "shop", keywords: ["automatik", "kategorie", "content", "inhalt", "typ", "fähigkeit", "name-style", "badge", "gutschein", "häufigkeit", "anzahl", "seltenheit", "tagesplan", "wochentag", "preisaufschlag", "rotation", "auto-generieren"], description: "Pro Kategorie: welcher Typ (Item/Fähigkeits-Gutschein/Style/Badge/Gutschein), Anzahl/Tag, Seltenheit, Preis, Wochentag-Regeln" },
  ...
  { label: "Fähigkeits-Gutschein-Effekte & Kombo", tab: "givables", keywords: ["effekt", "effecttype", "effectconfig", "kombo", "case_luck", "glück", "jackpot", "multiplikator", "loss", "rückgabe", "plinko", "snake", "don", "mine", "streak", "boost", "wert", "einheit", "prozent", "chance"], description: "Effekt-Typen (gruppiert + beschrieben), Wert/Einheit, Kombo-Effekte (effectConfig), Shop-Preis" },
  { label: "Fähigkeits-Gutschein im Shop verkaufen", tab: "shop", keywords: ["fähigkeit", "ability", "shop", "verkaufen", "preis", "kategorie", "kaufen"], description: "Fähigkeits-Gutscheine über eine Shop-Kategorie (Inhalt=Fähigkeits-Gutscheine) automatisch verkaufen" },
...
const TAB_DESC: Record<Tab, string> = {
  ...
  shop: "Tages-Shop: Automatik (Items/Fähigkeits-Gutscheine/Styles/Badges/Gutscheine), Kategorien, Tagesplan, Preise.",
