  ...
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      <div
        ...
        style={{
          background:
            "radial-gradient(closest-side, rgba(var(--glow-1),0.18) 0%, rgba(var(--glow-1),0.06) 45%, transparent 75%)",
        }}
      />
      <div
        ...
        style={{
          background:
            "radial-gradient(closest-side, rgba(var(--glow-2),0.12) 0%, transparent 70%)",
        }}
      />
      <div
        ...
        style={{
          background:
            "radial-gradient(closest-side, rgba(var(--glow-1),0.10) 0%, transparent 70%)",
        }}
      />
      <div
        ...
        style={{
          background:
            "radial-gradient(closest-side, rgba(var(--glow-2),0.07) 0%, transparent 70%)",
